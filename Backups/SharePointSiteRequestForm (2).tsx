  ...
  private renderFormBody() {
    ...
    return (
      ...
      <form style={containerCss} noValidate autoComplete="off">
        ...
        <TextFieldTemplate label="Life Expectancy of this site" placeHolder="Enter the No. of days" onChangeHandler={this.handleTextChange} />
        ...
        <DropDownTemplate label="Life Expectancy" placeHolder="--Choose the lifetime in days--" webPartContext={this.props.webpartContext} dataSource='Test' dataText='Title' dataValue='ID' required={true}/>
