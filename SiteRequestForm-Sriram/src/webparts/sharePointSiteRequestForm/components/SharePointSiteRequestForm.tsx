...
import DropDownTemplate from './field-templates/DropDown';
...
const getItemDataForPost = (formData: any) => {
  let itemData = {
    ...
    LifeExpectancy: formData["Life Expectancy of this site"]
  };
...
export default class SharePointSiteRequestForm extends React.Component<ISharePointSiteRequestFormProps, {}> {
  ...
  public handleDropDownChange = (fieldName: string, fieldValue: string) => {
    this.setState({
      formData: { ...this.state.formData, [fieldName]: fieldValue }
    });
    console.log("Field Name: ", fieldName);
  ...
  public handleLEChange = (fieldValue: number) => {
    this.setState({
      formData: { ...this.state.formData, ["LifeExpectancy"]: fieldValue }
    });
  }
  ...
  private renderFormBody() {
    ...
    return (
      ...
      <form style={containerCss} noValidate autoComplete="off">
        ...
        <TextFieldTemplate label="Life Expectancy" placeHolder="Enter the No. of days" onChangeHandler={this.handleTextChange} />
        {/* <TextFieldTemplate label="Life Expectancy of this site" placeHolder="Enter the No. of days" onChangeHandler={this.handleLEChange} /> */}

        <DropDownTemplate label="Life Expectancy" placeHolder="--Choose the lifetime in days--" webPartContext={this.props.webpartContext} dataSource='Test' dataText='Title' dataValue='ID' required={true} onChangeHandler={this.handleDropDownChange}/>
        <div>Version no: 2</div>
        <br />
